...
#ifndef JSONIFIER_STATIC_DATA_SECTION
	#define JSONIFIER_STATIC_DATA_SECTION
#else
	#define JSONIFIER_STATIC_DATA_SECTION_DEFINED 1
#endif
...
// C++20 std::bit_cast
	...
	#include <bit>
	#define JSONIFIER_HAS_BIT_CAST 1
#else
	#define JSONIFIER_HAS_BIT_CAST 0
#endif

// C++23 if consteval or C++20 std::is_constant_evaluated
#if defined(__cpp_if_consteval) && __cpp_is_consteval >= 202106L
	#define JSONIFIER_IF_CONSTEVAL if consteval
	#define JSONIFIER_IF_NOT_CONSTEVAL if !consteval
	...
	namespace dragonbox {
		...
		namespace detail {
			...
			namespace wuint {
				...
				BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr uint128 umul128(std::uint_least64_t x, std::uint_least64_t y) noexcept {
				...
				// integers.
				BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr std::uint_least64_t umul128_upper64(std::uint_least64_t x, std::uint_least64_t y) noexcept {
				...
				// unsigned integer.
				BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr uint128 umul192_upper128(std::uint_least64_t x, uint128 y) noexcept {
				...
				// unsigned integer.
				BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr uint128 umul192_lower128(std::uint_least64_t x, uint128 y) noexcept {
		...
		namespace policy {
			...
			namespace decimal_to_binary_rounding {
				...
				inline constexpr struct nearest_to_even_t {
					...
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_even_t>(), arg_types{}...)) delegate(SignedSignificandBits,
				...
				inline constexpr struct nearest_to_odd_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_to_odd_t>(), arg_types{}...)) delegate(SignedSignificandBits,
						Func f, arg_types... args) noexcept {
				...
				inline constexpr struct nearest_toward_plus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_plus_infinity_t>(), arg_types{}...)) delegate(
				...
				inline constexpr struct nearest_toward_minus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_minus_infinity_t>(), arg_types{}...)) delegate(
						SignedSignificandBits, Func f, arg_types... args) noexcept {
				...
				inline constexpr struct nearest_toward_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_toward_zero_t>(), arg_types{}...)) delegate(SignedSignificandBits,
						Func f, arg_types... args) noexcept {
				...
				inline constexpr struct nearest_away_from_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(std::declval<nearest_away_from_zero_t>(), arg_types{}...)) delegate(
						SignedSignificandBits, Func f, arg_types... args) noexcept {
				...
				inline constexpr struct nearest_to_even_static_boundary_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::nearest_always_closed_t{}, arg_types{}...)) delegate(SignedSignificandBits s,
						Func f, arg_types... args) noexcept {
				...
				inline constexpr struct nearest_toward_plus_infinity_static_boundary_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(nearest_toward_zero, arg_types{}...)) delegate(SignedSignificandBits s, Func f,
				...
				inline constexpr struct toward_plus_infinity_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::left_closed_directed_t{}, arg_types{}...)) delegate(SignedSignificandBits s,
						Func f, arg_types... args) noexcept {
				...
				inline constexpr struct toward_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::left_closed_directed_t{}, arg_types{}...)) delegate(SignedSignificandBits,
						Func f, arg_types... args) noexcept {
				...
				inline constexpr struct away_from_zero_t {
					...
					template<typename SignedSignificandBits, typename Func, typename... arg_types>
					BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr decltype(Func{}(detail::right_closed_directed_t{}, arg_types{}...)) delegate(SignedSignificandBits,
						Func f, arg_types... args) noexcept {
		...
		namespace detail {
			...
			template<typename FormatTraits> struct impl : private FormatTraits::format {
				...
				BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr return_type<SignPolicy, TrailingZeroPolicy, PreferredIntegerTypesPolicy> compute_nearest(
				...
				BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr return_type<SignPolicy, TrailingZeroPolicy, PreferredIntegerTypesPolicy>
				...
				template<typename SignPolicy, typename TrailingZeroPolicy, typename CachePolicy, typename PreferredIntegerTypesPolicy>
				BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS static constexpr return_type<SignPolicy, TrailingZeroPolicy, PreferredIntegerTypesPolicy> compute_right_closed_directed(
					signed_significand_bits<FormatTraits> s, exponent_int exponent_bits) noexcept {
					using cache_holder_type = typename CachePolicy::template cache_holder_type<format>;
					static_assert(min_k >= cache_holder_type::min_k && max_k <= cache_holder_type::max_k, "");
			...
			template<typename FormatTraits, typename PolicyHolder> struct to_decimal_dispatcher {
				...
				template<typename IntervalTypeProvider> BNCH_SWT_HOST JSONIFIER_SAFEBUFFERS constexpr return_type operator()(IntervalTypeProvider,
		...
		BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr detail::to_decimal_return_type<FormatTraits, Policies...> to_decimal_ex(signed_significand_bits<FormatTraits> s,
		...
		BNCH_SWT_HOST static JSONIFIER_SAFEBUFFERS constexpr detail::to_decimal_return_type<FormatTraits, Policies...> to_decimal(Float x, Policies... policies) noexcept {
